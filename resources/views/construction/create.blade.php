    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box box-warning">
                <div class="box-body">
                    <form class="form-group" action="{{ route('construction.store') }}" method="POST">
                        {{ csrf_field() }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('cost') ? 'has-error' : '' }}">
                                        ...
                                        <input type="number" class="form-control" name="cost" id"cost" style="width: 100%;">
                                        @if($errors->has('cost'))
                                            <span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                        <div class="form-group{{ $errors->has('details') ?  'has-error' : ''}}">
                                            ...
                                            <textarea class="form-control" name="details" id="details" cols="30" rows="10" style="width: 100%;"></textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('worker_name') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" name="worker_name" id"worker_name" style="width: 100%;">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('Worker_type') ? 'has-error' : '' }}">
                                        ...
                                        <select class="form-control select2" name="worker_type" id="worker_type" style="width: 100%;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('work_type') ? 'has-error' : '' }}">
                                        ...
                                        <select class="form-control select2" name="work_type" id="work_type" style="width: 100%;">
                                            <option selected="selected">Building</option>
                                            <option>Maintenance</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('location') ? 'has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" name="location" id="location" style="width: 100%;">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group{{ $errors->has('customer_id') ? 'has-error' : '' }}">
                                        ...
                                        <select class="form-control select2" name="construction_id" id="construction_id" style="width: 100%;">
                            ...
                            <!-- /row -->
                            <a href="{{ route('construction.index')}}" type="reset" class="btn btn-danger" value="Clear form">Cancel</a>
                            <button type="submit" class="btn btn-primary pull-right">Save Construction</button>
                    </form>
                </div>
            </div>
        </section>
